document.addEventListener("DOMContentLoaded", function () {
    ...
    if (datatableSearch && datatableBody && datatableInfoText && datatablePageSize && datatablePagination) {
        ...
        const renderPagination = function (totalFiltered, pageSize) {
            ...
            const normalBtn = baseBtn + " border-slate-700 bg-transparent text-slate-300 hover:bg-slate-800 hover:text-slate-100";
            const activeBtn = baseBtn + " border-indigo-600 bg-indigo-500 text-white";
            const disabledBtn = baseBtn + " border-slate-700 bg-transparent text-slate-500 opacity-50 cursor-not-allowed";
