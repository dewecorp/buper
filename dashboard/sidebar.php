...
function menuClass($page) {
    ...
    $base = 'flex items-center px-2.5 py-2 rounded-lg transition-colors duration-200 text-sm';
    if ($currentPage === $pageClean) {
        return $base . ' bg-emerald-600 text-white';
    }
    return $base . ' text-purple-200 hover:bg-emerald-600 hover:text-white';
}
?>
<div id="sidebar" class="fixed md:relative z-30 md:z-auto inset-y-0 left-0 md:flex flex-col w-56 flex-shrink-0 self-stretch border-r border-purple-800 bg-purple-900 overflow-y-auto scroll-thin -translate-x-full md:translate-x-0 transition-transform duration-200 pt-14 md:pt-0">
    <div class="flex flex-col p-3 flex-1">
        ...
        <nav class="flex-1 space-y-0.5">
            ...
            <a href="index.php" class="<?= menuClass('index.php') ?>">
            ...
            <?php if (isAdmin()): ?>
                <a href="profil_buper.php" class="<?= menuClass('profil_buper.php') ?>">
                ...
                <a href="pengelola.php" class="<?= menuClass('pengelola.php') ?>">
                ...
                <a href="fasilitas.php" class="<?= menuClass('fasilitas.php') ?>">
                ...
                <a href="biaya.php" class="<?= menuClass('biaya.php') ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    Data Biaya
                </a>
                <a href="users.php" class="<?= menuClass('users.php') ?>">
                ...
                <a href="izin_penggunaan.php" class="<?= menuClass('izin_penggunaan.php') ?>">
                ...
                <a href="pengaturan.php" class="<?= menuClass('pengaturan.php') ?>">
            ...
            <button onclick="confirmLogout()" class="flex items-center w-full px-2.5 py-2 rounded-lg text-red-300 hover:bg-red-600 hover:text-white transition-colors duration-200 text-sm">
