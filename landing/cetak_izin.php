...
<body class="bg-gray-100 p-8">
    <div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-lg border border-gray-200 p-8 print:shadow-none print:border-0">
        ...
        <table class="w-full text-sm">
            <tr><td class="py-1.5 pr-4 text-gray-500 w-40">No. Registrasi</td><td class="py-1.5 font-semibold">#<?= str_pad($row['id'], 4, '0', STR_PAD_LEFT) ?></td></tr>
            <tr><td class="py-1.5 pr-4 text-gray-500">Nama Pemohon</td><td class="py-1.5 font-semibold"><?= e($row['nama_peminjam']) ?></td></tr>
            <tr><td class="py-1.5 pr-4 text-gray-500">Organisasi</td><td class="py-1.5 font-semibold"><?= e($row['organisasi'] ?? '-') ?></td></tr>
            <tr><td class="py-1.5 pr-4 text-gray-500">Telepon</td><td class="py-1.5 font-semibold"><?= e($row['telepon'] ?? '-') ?></td></tr>
            <tr><td class="py-1.5 pr-4 text-gray-500">Email</td><td class="py-1.5 font-semibold"><?= e($row['email'] ?? '-') ?></td></tr>
            <tr><td class="py-1.5 pr-4 text-gray-500">Tanggal Mulai</td><td class="py-1.5 font-semibold"><?= e(formatTanggal($row['tanggal_mulai'])) ?></td></tr>
            <tr><td class="py-1.5 pr-4 text-gray-500">Tanggal Selesai</td><td class="py-1.5 font-semibold"><?= e(formatTanggal($row['tanggal_selesai'])) ?></td></tr>
            <tr><td class="py-1.5 pr-4 text-gray-500">Jumlah Peserta</td><td class="py-1.5 font-semibold"><?= e($row['jumlah_peserta']) ?> orang</td></tr>
            <tr><td class="py-1.5 pr-4 text-gray-500">Keperluan</td><td class="py-1.5 font-semibold"><?= nl2br(e($row['keperluan'] ?? '-')) ?></td></tr>
            <tr><td class="py-1.5 pr-4 text-gray-500">Status</td><td class="py-1.5"><span style="color:<?= $statusColor ?>; font-weight:700"><?= $statusLabel ?></span></td></tr>
            <?php if (!empty($row['catatan_admin'])): ?>
            <tr><td class="py-1.5 pr-4 text-gray-500 align-top">Catatan Admin</td><td class="py-1.5 font-semibold"><?= nl2br(e($row['catatan_admin'])) ?></td></tr>
            <?php endif; ?>
        </table>
